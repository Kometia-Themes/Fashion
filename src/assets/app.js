$(document).ready(function() {
  ...
  var getProductHeight = function() {
      ...
      $(type2).css({
          "height": type2.width() * .6
      });
      $(type3).css({
          "height": type3.width() * 1.6
      });
  }
  // Init dropdown menu
  ...
  var getWidth = function() {
      ...
      if (isSmallMobile()) {
          ...
          _rectangle.css({
              'height': _rectangleWidth
          });
          _rectanglefull.css({
              'height': _rectanglefullWidth
          });
      } else {
          _square.css({
              'height': _squareWidth
          ...
          _rectangle.css({
              'height': _rectangleWidth * .62
          });
          _rectanglefull.css({
              'height': _rectanglefullWidth * .52
          });
      }
  }
  getWidth();
