...
function() {
  ...
  var isSmallMobile = function() {
    return ( win.width() < 480 ? true : false );
  }
  // Init slick slider
  ...
  var getProductHeight = function() {
    ...
    $(type2).css({ "height": type2.width() * .6 });
    $(type3).css({ "height": type3.width() * 1.6 });
  }
  // Init dropdown menu
  ...
  var getWidth = function() {
    var _square = $('.collection__item--square');
    var _squareWidth = _square.width();
    var _rectangle = $('.collection__item--rectangle');
    var _rectangleWidth = _rectangle.width();
    var _rectanglefull = $('.collection__item--rectangle--full');
    var _rectanglefullWidth = _rectanglefull.width();
    if(isSmallMobile()) {
      _square.css({ 'height': _squareWidth });
      _rectangle.css({ 'height': _rectangleWidth });
      _rectanglefull.css({ 'height': _rectanglefullWidth });
    } else {
      _square.css({ 'height': _squareWidth });
      _rectangle.css({ 'height': _rectangleWidth * .62 });
      _rectanglefull.css({ 'height': _rectanglefullWidth * .52 });
    }
  }
  getWidth();
  // Init dropdown menu
